...
with open("/home/scrapeops/ex-politica-scrape/Apify/Results/Instagram/Instagram_Posts.json", "w") as f:
    f.write(json_str)
    
with open("/home/scrapeops/ex-politica-scrape/Apify/Results/Instagram/Instagram_Posts_Urls.json", "w") as f:
    f.write(posts_str)
    
upload_file("/home/scrapeops/ex-politica-scrape/Apify/Results/Instagram/Instagram_Posts.json", "axioon", f"Apify/Instagram/Posts/Instagram_Posts_{timestamp}.json")
