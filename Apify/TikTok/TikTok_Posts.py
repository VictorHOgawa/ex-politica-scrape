...
for tiktok_name, tiktok_id in zip(tiktok_names, tiktok_ids):
    ...
    if json_str != "":
        upload_file(f"/home/scrapeops/Axioon/Apify/Results/TikTok/TikTok_Posts_{tiktok_name}.json", "axioon", f"Apify/TikTok/Posts/TikTok_Posts_{tiktok_name}_{timestamp}.json")
