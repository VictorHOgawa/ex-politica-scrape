...
# with open("Apify/Results/TikTok/TikTok_Posts.json", "w") as f:
#     f.write(json_str)
    
# upload_file("Apify/Results/TikTok/TikTok_Posts.json", "nightapp", f"Apify/TikTok/TikTok_Posts_{timestamp}.json")