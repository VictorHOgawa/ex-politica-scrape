...
with open(f"/home/scrapeops/Axioon/Apify/Results/Facebook_Page.json", "w") as f:
    f.write(json_str)
    
upload_file(f"/home/scrapeops/Axioon/Apify/Results/Facebook_Page.json", "nightapp", f"MT/Apify/Facebook/Facebook_Page_{timestamp}.json")