...
with open("/home/scrapeops/Axioon/Init_Apify/Results/Facebook/Facebook_Posts.json", "w") as f:
    f.write(json_str)
    
with open("/home/scrapeops/Axioon/Init_Apify/Results/Facebook/Facebook_Posts_Urls.json", "w") as f:
    f.write(posts_str)
    
upload_file("/home/scrapeops/Axioon/Init_Apify/Results/Facebook/Facebook_Posts.json", "axioon", f"Apify/Facebook/Posts/Facebook_Posts_{timestamp}.json")
