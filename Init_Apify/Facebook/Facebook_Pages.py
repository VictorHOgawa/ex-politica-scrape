...
with open("/home/scrapeops/Axioon/Init_Apify/Results/Facebook/Facebook_Pages.json", "w") as f:
    f.write(json_str)
    
upload_file(f"/home/scrapeops/Axioon/Init_Apify/Results/Facebook/Facebook_Pages.json", "axioon", f"Apify/Facebook/Pages/Facebook_Pages_{timestamp}.json")
