...
with open("/home/scrapeops/Axioon/Init_Apify/Results/Youtube/Youtube_Videos.json", "w") as f:
    f.write(json_str)

with open("/home/scrapeops/Axioon/Init_Apify/Results/Youtube/Youtube_Videos_Urls.json", "w") as f:
    f.write(posts_str)
    
upload_file(f"/home/scrapeops/Axioon/Init_Apify/Results/Youtube/Youtube_Videos.json", "axioon", f"Apify/YouTube/Videos/YouTube_Videos_{timestamp}.json")
