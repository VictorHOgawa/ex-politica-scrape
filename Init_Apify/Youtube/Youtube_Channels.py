...
with open("/home/scrapeops/ex-politica-scrape/Init_Apify/Results/Youtube/Youtube_Channel.json", "w") as f:
    f.write(json_str)
    
upload_file("/home/scrapeops/ex-politica-scrape/Init_Apify/Results/Youtube/Youtube_Channel.json", "axioon", f"Apify/YouTube/Channels/YouTube_Channels_{timestamp}.json")
