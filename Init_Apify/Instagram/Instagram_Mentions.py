...
with open ("/home/scrapeops/ex-politica-scrape/Init_Apify/Results/Instagram/Instagram_Mentions.json", "w") as f:
    f.write(json_str)

with open("/home/scrapeops/ex-politica-scrape/Init_Apify/Results/Instagram/Instagram_Mentions_Urls.json", "w") as f:
    f.write(posts_str)
    
upload_file("/home/scrapeops/ex-politica-scrape/Init_Apify/Results/Instagram/Instagram_Mentions.json", "axioon", f"Apify/Instagram/Mentions/Instagram_Mentions_{timestamp}.json")
