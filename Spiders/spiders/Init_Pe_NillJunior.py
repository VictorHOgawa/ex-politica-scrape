...
request = requests.get(f"{os.environ['API_IP']}/scrape/news/772617db-e4bd-4866-bc11-d29eb7de0a0f")
search_words = request.json()

with open("/home/scrapeops/ex-politica-scrape/Spiders/CSS_Selectors/PE/Pe_NillJunior.json") as f:
